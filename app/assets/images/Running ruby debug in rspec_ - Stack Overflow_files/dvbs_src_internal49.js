...
try {
	...
	dv_handler99.prototype = dv_baseHandlerIns;
dv_handler99.prototype.constructor = dv_handler99;

    var dv_handlersDefs = [{handler: new dv_handler99(), minRate: 0, maxRate: 90}];
